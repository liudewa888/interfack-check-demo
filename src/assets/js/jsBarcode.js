...
, function(t, e, n) {
  ...
  var o, i = e.SET_A = 0, u = e.SET_B = 1, a = e.SET_C = 2, f = (e.SHIFT = 98,
      ...
      u(e, [{
          ...
          value: function(t, n, r) {
              ...
              if (t[0] >= 200) {
                  i = t.shift() - 105;
                  var u = c.SWAP[i];
                  void 0 !== u ? o = e.next(t, n + 1, u) : (r !== c.SET_A && r !== c.SET_B || i !== c.SHIFT || (t[0] = r === c.SET_A ? t[0] > 95 ? t[0] - 96 : t[0] : t[0] < 32 ? t[0] + 96 : t[0]),
                  o = e.next(t, n + 1, r))
              } else
      ...
      return o(t, [{
          ...
          value: function() {
              ...
              for (var t = 0; t < this.encodings.length; t++) {
                  var e = (0,
                  u.default)(this.options, this.encodings[t].options);
      ...
      return o(t, [{
          ...
          value: function() {
              ...
              for (var e = 0; e < this.encodings.length; e++) {
                  var n = this.encodings[e]
                    , r = (0,
                  u.default)(this.options, n.options)
          ...
          value: function(t, e, n) {
              ...
              for (var i = 0, u = 0, a = 0; a < o.length; a++)
                  ...
                  "1" === o[a] ? i++ : i > 0 && (this.drawRect(u - e.width * i, r, e.width * i, e.height, t),
                  i = 0);
